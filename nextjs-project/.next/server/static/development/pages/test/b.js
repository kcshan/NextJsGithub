...
class MyCount extends react__WEBPACK_IMPORTED_MODULE_1___default.a.Component {
  ...
  render() {
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("span", null, this.state.count);
  }
...
const MyCountFunc = () => {
  ...
  const [count, dispatchCount] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useReducer"])(countReducer, 0); // setCount(1)
  // setCount(c => 1)
